...
var dialogs = {};
//function show(dlg, selected_btn){
//    var btn_name = selected_btn;
//    if (!dialogs[dlg]) {
...
//                if(btn_name === "btn_size") $("#btn_size_txt").text(selected_value);
//                if(btn_name === "btn_pos") {
...
function showBannerSize() {
    //show("banner_size.html", "btn_size");
